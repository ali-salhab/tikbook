...
const getStyles = (theme) =>
  StyleSheet.create({
    ...
    storiesRowContent: { paddingHorizontal: ms(12), gap: ms(10) },
    storyWrap: { alignItems: "center", width: ms(62) },
    storyRing: {
      width: ms(56),
      height: ms(56),
      borderRadius: ms(28),
    ...
    storyRingOwn: { borderWidth: 1.5, borderColor: "#25D366" },
    storyRingOther: { borderWidth: 1.5, borderColor: theme.avatarRing },
    storyCircleInner: {
      flex: 1,
      borderRadius: ms(30),
      overflow: "hidden",
